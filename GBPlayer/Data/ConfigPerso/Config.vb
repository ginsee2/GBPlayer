...
'***********************************************************************************************
Public Class Config
    Public Class DescriptionColonnes
        <ToSerialize> Public NomColonne As String
        <ToSerialize> Public Position As String
        <ToSerialize> Public Taille As String
    End Class
    Public Class DescriptionTri
        <ToSerialize> Public NomColonne As String
        <ToSerialize> Public Sens As String
    End Class
    ...
    <ToSerialize> Public Nom As String = "GBPLayer"
    <ToSerialize> Public Version As String = GBAU_VERSIONCONFIG
    <ToSerialize> Public MAINWINDOW_Position As Point = New Point(0, 0)
    <ToSerialize> Public MAINWINDOW_Size As Size = New Size(200, 200)
    <ToSerialize> Public PLAYERVOLUME0 As String = "100"
    <ToSerialize> Public LISTEREPERTOIRES_Racine As String = ""
    <ToSerialize> Public LISTEREPERTOIRES_RepertoireEnCours As String = ""
    <ToSerialize> Public LISTEFICHIERSMP3_ListeColonnes As New List(Of DescriptionColonnes)  'Liste des colonnes de la liste fichier avec lors configuration
    <ToSerialize> Public LISTEFICHIERSMP3_ColonneTriee As String = "Nom;A"
    <ToSerialize> Public LISTECOLLECTION_ListeColonnes As New List(Of DescriptionColonnes)  'Liste des colonnes de la liste vinyl avec lors configuration
    <ToSerialize> Public LISTECOLLECTION_ColonneTriee As String = "Nom;A"
    <ToSerialize> Public LISTECOLLECTION_BackUpDirectory As String = ""
    <ToSerialize> Public WANTLIST_ListeColonnes As New List(Of DescriptionColonnes)  'Liste des colonnes de la liste des recherches avec lors configuration
    <ToSerialize> Public WANTLIST_ColonneTriee As String = "Nom;A"
    <ToSerialize> Public LISTECD_ListeColonnes As New List(Of DescriptionColonnes)  'Liste des colonnes de la liste vinyl avec lors configuration
    <ToSerialize> Public LISTECD_ColonneTriee As String = "Nom;A"
    <ToSerialize> Public FILESINFOS_ParametrageMenuTitre As New List(Of String) 'Paramétrage du menu contextuel sur la zone titre du tag ID3
    <ToSerialize> Public FILESINFOS_ChaineFormattageNom As String = "%ARTISTE% - %TITRE%"
    <ToSerialize> Public FILESINFOS_ChaineExtractionInfos As String = "%ARTISTE%-%TITRE%"
    <ToSerialize> Public DISCOGSCONNECTION_consumerKey As String = ""
    <ToSerialize> Public DISCOGSCONNECTION_consumerSecret As String = ""
    <ToSerialize> Public DISCOGSCONNECTION_tokenValue As String = ""
    <ToSerialize> Public DISCOGSCONNECTION_tokenSecret As String = ""
    <ToSerialize> Public USER_name As String = ""
    <ToSerialize> Public USER_ID As String = ""
    <ToSerialize> Public SELLLIST_ListeColonnes As New List(Of DescriptionColonnes)  'Liste des colonnes de la liste des vinyls a vendre avec lors configuration
    <ToSerialize> Public SELLLIST_ColonneTriee As String = "Nom;A"
    <ToSerialize> Public PHONESYNCHRO_Directory As String = "C:\"
    <ToSerialize> Public PHONESYNCHRO_ListeColonnes As New List(Of DescriptionColonnes)
    <ToSerialize> Public PHONESYNCHRO_ColonneTriee As String = "Nom;A"
