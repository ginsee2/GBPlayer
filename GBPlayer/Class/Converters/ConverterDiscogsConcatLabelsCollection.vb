...
Public NotInheritable Class ConverterDiscogsConcatLabelsCollection
        ...
        If CType(value, IEnumerable) IsNot Nothing Then
            ...
            For Each i As XmlElement In CType(value, IEnumerable)
                ...
                For Each j As XmlElement In i
                    ...
                    If j.Name = "catno" Then catno = j.InnerText
                    If j.Name = "id" Then id = j.InnerText
                Next
                If Nom <> "" Then
                    Dim Bloc As TextBlock = New TextBlock()
                    Bloc.Name = "tag" & IIf(id = "", "No", "") & "LinkLabel"
                    Bloc.Foreground = Brushes.Black
                    Bloc.Text = Nom
                    Bloc.Tag = i.Item("id")
                    Ensemble.Children.Add(Bloc)
                    Dim BlocC As TextBlock = New TextBlock()
                    BlocC.Name = "tagLabelCatno"
                    BlocC.Foreground = Brushes.Black
                    BlocC.Text = " - " & catno
                    BlocC.Tag = i.Item("id")
                    Ensemble.Children.Add(BlocC)
                End If
            Next
